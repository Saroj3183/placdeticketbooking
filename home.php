...
<a name="riz" ></a>
    <nav class="wrapper1">
        <ul class="links1">
            <!--li><a href="signup/signup.html" target="_blacnk">Sign up</a></li>
            <li><a href="signin/signin.html" target="_blacnk">Sign in</a></li-->
            <!--li><a href="signin/profile2.php"><p class="fa fa-user" align="center" >welcome <?php echo $_SESSION['username']; ?></p></li-->
        <li><a href="signin/p.php"><p class="fa fa-user" align="center" >welcome <?php echo $_SESSION['username']; ?></p></li>
        </ul>
    ...
    <div class="wrapper">
        <nav>
            ...
            <ul class="links">
                ...
                <li><a href="g/gallery1.php">Gallery</a></li>
  ...
  <form action="s1.php" method="post" style="margin:10px 50px 10px;">
